...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12921 = 0;while(true){
if((i_12921 < arr.length))
{(arr[i_12921] = null);
{
var G__12922 = (i_12921 + 1);
i_12921 = G__12922;
continue;
}
} else
...
{var i_12928 = (self__.level + 1);while(true){
if((i_12928 <= (new_level + 1)))
{(update[i_12928] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12930 = 0;while(true){
if((i_12930 <= self__.level))
{var links_12931 = (update[i_12930]).forward;if(((links_12931[i_12930]) === x__$1))
{(links_12931[i_12930] = (x__$1.forward[i_12930]));
{
var G__12932 = (i_12930 + 1);
i_12930 = G__12932;
continue;
}
} else
{{
var G__12933 = (i_12930 + 1);
i_12930 = G__12933;
continue;
}
}
