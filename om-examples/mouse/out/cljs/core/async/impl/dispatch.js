...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12956 = 0;while(true){
var m_12957 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12957 == null))
{} else
{m_12957.call(null);
if((count_12956 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12958 = (count_12956 + 1);
count_12956 = G__12958;
continue;
}
} else
{}
