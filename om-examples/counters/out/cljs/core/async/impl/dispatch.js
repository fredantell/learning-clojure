...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12963 = 0;while(true){
var m_12964 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12964 == null))
{} else
{m_12964.call(null);
if((count_12963 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12965 = (count_12963 + 1);
count_12963 = G__12965;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__4059__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__4059__auto__)
