...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4638__auto__,writer__4639__auto__,opt__4640__auto__){return cljs.core._write.call(null,writer__4639__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_37853 = 0;while(true){
if((i_37853 < arr.length))
{(arr[i_37853] = null);
{
var G__37854 = (i_37853 + 1);
i_37853 = G__37854;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4638__auto__,writer__4639__auto__,opt__4640__auto__){return cljs.core._write.call(null,writer__4639__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_37860 = (self__.level + 1);while(true){
if((i_37860 <= (new_level + 1)))
{(update[i_37860] = self__.header);
{
var G__37861 = (i_37860 + 1);
i_37860 = G__37861;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_37862 = 0;while(true){
if((i_37862 <= self__.level))
{var links_37863 = (update[i_37862]).forward;if(((links_37863[i_37862]) === x__$1))
{(links_37863[i_37862] = (x__$1.forward[i_37862]));
{
var G__37864 = (i_37862 + 1);
i_37862 = G__37864;
continue;
}
} else
{{
var G__37865 = (i_37862 + 1);
i_37862 = G__37865;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__4071__auto__ = (cljs.core.truth_((function (){var and__4059__auto__ = me;if(cljs.core.truth_(and__4059__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__4059__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__4071__auto__))
