...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12969 = 0;while(true){
var m_12970 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12970 == null))
{} else
{m_12970.call(null);
if((count_12969 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12971 = (count_12969 + 1);
count_12969 = G__12971;
continue;
}
} else
{}
