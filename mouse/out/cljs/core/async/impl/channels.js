...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12962 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12962 = (function (val,box,meta12963){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12962.cljs$lang$type = true;
cljs.core.async.impl.channels.t12962.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12962";
cljs.core.async.impl.channels.t12962.cljs$lang$ctorPrWriter = (function (this__4638__auto__,writer__4639__auto__,opt__4640__auto__){return cljs.core._write.call(null,writer__4639__auto__,"cljs.core.async.impl.channels/t12962");
});
cljs.core.async.impl.channels.t12962.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12962.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12964){var self__ = this;
var _12964__$1 = this;return self__.meta12963;
});
cljs.core.async.impl.channels.t12962.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12964,meta12963__$1){var self__ = this;
var _12964__$1 = this;return (new cljs.core.async.impl.channels.t12962(self__.val,self__.box,meta12963__$1));
});
cljs.core.async.impl.channels.__GT_t12962 = (function __GT_t12962(val__$1,box__$1,meta12963){return (new cljs.core.async.impl.channels.t12962(val__$1,box__$1,meta12963));
});
}
return (new cljs.core.async.impl.channels.t12962(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12965 = self__.takes.pop();if((taker_12965 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12965))
{var take_cb_12966 = cljs.core.async.impl.protocols.commit.call(null,taker_12965);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12966,taker_12965){
return (function (){return take_cb_12966.call(null,null);
});})(take_cb_12966,taker_12965))
);
} else
{}
{
