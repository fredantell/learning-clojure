...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_37888 = 0;while(true){
var m_37889 = cljs.core.async.impl.dispatch.tasks.pop();if((m_37889 == null))
{} else
{m_37889.call(null);
if((count_37888 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__37890 = (count_37888 + 1);
count_37888 = G__37890;
continue;
}
} else
{}
