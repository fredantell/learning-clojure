...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t37894 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t37894 = (function (val,box,meta37895){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t37894.cljs$lang$type = true;
cljs.core.async.impl.channels.t37894.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t37894";
cljs.core.async.impl.channels.t37894.cljs$lang$ctorPrWriter = (function (this__4638__auto__,writer__4639__auto__,opt__4640__auto__){return cljs.core._write.call(null,writer__4639__auto__,"cljs.core.async.impl.channels/t37894");
});
cljs.core.async.impl.channels.t37894.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t37894.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37896){var self__ = this;
var _37896__$1 = this;return self__.meta37895;
});
cljs.core.async.impl.channels.t37894.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37896,meta37895__$1){var self__ = this;
var _37896__$1 = this;return (new cljs.core.async.impl.channels.t37894(self__.val,self__.box,meta37895__$1));
});
cljs.core.async.impl.channels.__GT_t37894 = (function __GT_t37894(val__$1,box__$1,meta37895){return (new cljs.core.async.impl.channels.t37894(val__$1,box__$1,meta37895));
});
}
return (new cljs.core.async.impl.channels.t37894(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_37897 = self__.takes.pop();if((taker_37897 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_37897))
{var take_cb_37898 = cljs.core.async.impl.protocols.commit.call(null,taker_37897);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_37898,taker_37897){
return (function (){return take_cb_37898.call(null,null);
});})(take_cb_37898,taker_37897))
);
} else
{}
{
